                            ...
                            <div class="container-fluid">
                             ...
                             <?php if($_SESSION['identity']=="admin"): ?>
                                        <a class="dashboard-stat bg-primary" href="manage-students.php">
                                            ...
                                            <?php if($_SESSION['identity']=="Professor" or $_SESSION['identity']=="Student" ): ?>
                                            <a class="dashboard-stat bg-primary" href="see-student.php">
                                                <?php endif; ?>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                       <?php if($_SESSION['identity']=="admin"): ?>
                                        ...
                                        <a class="dashboard-stat bg-success" href="manage-results.php">
                                            ...
                                            <a class="dashboard-stat bg-success" href="see-result.php">
